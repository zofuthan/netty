...
final class AutoPooledDirectByteBuf extends AutoPooledByteBuf<ByteBuffer> {

    AutoPooledDirectByteBuf(int maxCapacity) {
        super(maxCapacity);
    }
    ...
    public ByteBuf getBytes(int index, ByteBuf dst, int dstIndex, int length) {
        ...
        if (dst instanceof AutoPooledDirectByteBuf) {
            AutoPooledDirectByteBuf bbdst = (AutoPooledDirectByteBuf) dst;
    ...
    public ByteBuf setBytes(int index, ByteBuf src, int srcIndex, int length) {
        checkIndex(index, length);
        if (src instanceof AutoPooledDirectByteBuf) {
            AutoPooledDirectByteBuf bbsrc = (AutoPooledDirectByteBuf) src;
