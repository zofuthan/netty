...
public class LocalTransportThreadModelTest {
    ...
    public void testStagedExecution() throws Throwable {
        ...
        ch.pipeline().addLast(new ExecutingChannelHandler(e1.next(), h2));
        // h3 will be always invoked by EventExecutor 'e2'.
        ch.pipeline().addLast(new ExecutingChannelHandler(e2.next(), h3));
    ...
    public void testConcurrentMessageBufferAccess() throws Throwable {
        ...
        try {
            ...
            pipeline.addLast(h1);
            pipeline.addLast(new ExecutingChannelHandler(e1.next(), h2));
            pipeline.addLast(new ExecutingChannelHandler(e2.next(), h3));
            pipeline.addLast(new ExecutingChannelHandler(e3.next(), h4));
            pipeline.addLast(new ExecutingChannelHandler(e4.next(), h5));
            pipeline.addLast(new ExecutingChannelHandler(e5.next(), h6));
